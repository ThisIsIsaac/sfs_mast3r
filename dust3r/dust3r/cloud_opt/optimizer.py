...
class PointCloudOptimizer(BasePCOptimizer):
    ...
    def __init__(self, *args, optimize_pp=False, focal_break=20, **kwargs):
        ...
        self.register_buffer('_grid', ParameterStack(
            [geometry.xy_grid(W, H, device=self.device) for H, W in self.imshapes], fill=self.max_area))
    ...
    def depth_to_pts3d(self):
        ...
        return geometry.geotrf(im_poses, rel_ptmaps)
    ...
    def forward(self):
        ...
        aligned_pred_i = geometry.geotrf(pw_poses, pw_adapt * self._stacked_pred_i)
        aligned_pred_j = geometry.geotrf(pw_poses, pw_adapt * self._stacked_pred_j)
